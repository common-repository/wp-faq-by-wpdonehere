...
class FAQ
{
    ...
    {
        wp_enqueue_script('faq.backend', PLUGINURL . 'js/backend.js', array( 'jquery', 'quicktags' ));
    }
    ...
    public function get_questions($term_slug)
    {
        ...
        if($questions->have_posts()):
            ...
            while($questions->have_posts()): $questions->the_post(); global $post;
                ...
                $response[$i-1]['post_content'] = $post->post_content;
    ...
    {
        add_meta_box( 'faq_metabox', 'Contact Us!', array( $this, 'faq_metabox' ), 'faq', 'side', 'high' );
    }	
    ...
    public function faq_metabox( $post )
    { ?>
    <div style="text-align: center;">
		<a href="http://wpdonehere.com" target="_blank"><img src="<?php echo PLUGINURL ?>images/logo.png" title="Premium WP Support" alt="Premium WP Support" /></a>
        <h2><a href="http://wpdonehere.com" target="_blank" class="left">WPDoneHere.com</a></h2>
        <em>Wordpress Sites, Plugins, Support And More</em>
        <strong>307-459-1092</strong>
    </div>
    <?php
    }
...
// Add Metabox
add_action( 'admin_init', array( $FAQ, 'add_meta_boxes' ));